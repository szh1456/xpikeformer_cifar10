...
class LSA(nn.Module):
    ...
    def forward(self, x):
        ...
        # the diagonal mask is to prevent a position from attending to itself
...
class ViT(nn.Module):
    def __init__(
        ...
        self.depth = depth
        self.heads = heads
        self.is_sto = is_sto # this atrribute does nothing
        ...
        self.pos_embedding = nn.Embedding(self.n_positions, self.dim)
    ...
    def forward(self, img):
        ...
        x += pos_embed  # (b, n+1, d) + (1, n+1, d) = (b, n+1, d)
        x = self.dropout(x)
